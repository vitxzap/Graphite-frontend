  ...
  const submit = handleSubmit(async (data) => {
    ...
    toaster.promise(fetchData, {
      ...
      error: {
        title: "Erro",
        description:
          "Houve algum erro ao gerar a documentação. Tente novamente mais tarde.",
      },
    });
  });
      ...
      >
        <DefaultBox width="1/2" gap={4} padding="6">
          <Flex direction="column" gap="2">
            ...
            <Text color="fg.muted">
              Utilize os campos abaixo para documentar um novo alerta.
            </Text>
          </Flex>
